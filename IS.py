...
def ali_imran_victory():
    ...
    team_name = "Pakeishya Secret Service"
...
# This Python code defines a function ali_imran_victory() that compiles the script based on the provided details. When you call this function, it will print out the compiled script.